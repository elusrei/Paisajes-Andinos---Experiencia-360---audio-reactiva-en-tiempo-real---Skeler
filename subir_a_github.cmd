...
:: 3. Verificar o pedir la URL remota de GitHub
set REMOTE_URL=
...
if "%REMOTE_URL%"=="" (
    ...
    echo.
    echo Quieres usar este mismo repositorio? (S/N)
    set /p RESP="Respuesta [S]: "
    if /i "%RESP%"=="N" (
...
echo 2. Ve a: Settings (Pestana de Configuracion) ^> Pages (en el menu izquierdo).
